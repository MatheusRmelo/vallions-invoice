...
const AddRuleRow: React.FC<AddRuleRowProps> = ({ mockInstitutes }) => {
    return (
        <Grid container spacing={1} alignItems="center">
            <Grid item xs={12} sm={3}>
                <FormControl fullWidth>
                    <InputLabel id="tableValue-label">Nivel de Prioridade</InputLabel>
            ...
            <Grid item xs={12} sm={3}>
                <FormControl fullWidth>
                    <InputLabel id="-label">Selecione Tabela de Valores</InputLabel>
            ...
            <Grid item xs={12} sm={2}>
                <FormControl fullWidth>
                    <InputLabel id="tag-label">Selecione o tipo de cobrança</InputLabel>
