...
const BillingView = ({ billings, expandedRowIds, handleExpandClick, handleChangeCheckedBilling, handleChangeCheckedReport }: Props) => {
    return (
        <Box
            sx={{
                height: '100%',
                        ...
                        renderCell(params) {
                            return (
                                <Chip
                                    variant="outlined"
                                    color={
                                        params.value == 0 ? 'primary' : params.value == 1 ? 'success' : params.value == 2 ? 'error' : 'info'
                                    }
                                    label={
                                        params.value == 0
                                                        ...
                                                        renderCell: (params) => (
                                                            <Box>
                                                                <Checkbox
                                                                    ...
                                                                    onChange={(v) => handleChangeCheckedReport(row.id, params.row.id)}
                                                                />
...

                                                    {
                                                        ...
                                                        renderCell(params) {
                                                            return (
                                                                <Box>
                                                                    <IconButton>
                                                                        <DeleteOutline sx={{ color: 'action.active' }} />
                                                                    </IconButton>
